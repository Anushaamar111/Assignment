...
import com.example.assignment.databinding.ActivityOtpnextBinding
...
class OTPnext : AppCompatActivity() {
//    private lateinit var binding: ActivityOtpnextBinding
...
//            }
 //       }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityOtpnextBinding.inflate(layoutInflater)
        setContentView(binding.root)
